/*
 * parse_ef.js is build to ingest Inspire EF files
 *
 * provides url to ef record (var ef_address)
 * function will open that file and parse some (not all) avaiable fields from the inspire EF schema
 * built for Inspire EF records generated by DEIMS-SDR (https://data.lter-europe.net/deims/)
 *
